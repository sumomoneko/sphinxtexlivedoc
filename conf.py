...
# -*- coding: utf-8 -*-
#
# sphinx texlive documentation build configuration file, created by
# sphinx-quickstart on Thu Nov  7 13:30:05 2019.
#
...
project = 'sphinx texlive'
copyright = '2019, sumomoneko'
author = 'sumomoneko'
...
htmlhelp_basename = 'sphinxtexlivedoc'
...
latex_documents = [
    (master_doc, 'sphinxtexlive.tex', 'sphinx texlive Documentation',
     'sumomoneko', 'howto'),
]
...
man_pages = [
    (master_doc, 'sphinxtexlive', 'sphinx texlive Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinxtexlive', 'sphinx texlive Documentation',
     author, 'sphinxtexlive', 'One line description of project.',
     'Miscellaneous'),
]
